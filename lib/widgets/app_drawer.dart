...
import '../screens/manpower_rules_screen.dart';
...
/// the rest of the app without retyping this menu each time. Menu
/// items are shown or hidden based on the logged-in user's role, so a
/// Supervisor or Viewer never even sees an option they're not allowed
/// to use (the underlying screens are also guarded independently, so
/// this is a convenience, not the only line of defense).
        ...
        children: [
          ...
          if (perms.canManageLeave)
            ListTile(
              ...
              onTap: () => _go(context, const LeaveRequestsScreen()),
            ),
          ...
          if (perms.isAdmin)
            ListTile(
              ...
              title: const Text('Manpower Rules'),
              onTap: () => _push(context, const ManpowerRulesScreen()),
            ),
